...
?>
<?$this->SetViewTarget("filter_area");?>
<div class="col-lg-3 filter">
	<div class="wrap">
		<div class="reset">
            <a href="javascript:void(0)" onclick="$('#filter_f .res-btn').click();">
                <span>&times;</span>
                Сбросить параметры
            </a>
        </div>
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" id="filter_f" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
						...
						<div class="wrap-b">
							...
							switch ($arItem["DISPLAY_TYPE"])
							{
								...
								default://CHECKBOXES
									?>
									<?foreach($arItem["VALUES"] as $val => $ar):?>
										<div class="input checkbox<? echo $ar["CHECKED"]? ' active"': '' ?>">
                           				    <input
												type="checkbox"
											...
											/>
                           				    <label for=""><?=$ar["VALUE"];?></label>
                           				    <span class="count-f"><? echo $ar["ELEMENT_COUNT"]; ?></span>
                           				</div>
									<?endforeach;?>
...
<?$this->EndViewTarget("filter_area");?>