...
<div class="panel_search modifier">
...
<?else:?>
	<input type="text" name="q" class="search" value="<?=$arResult["REQUEST"]["QUERY"]?>" size="40" />
<?endif;?>
	<input type="submit" class="btn-search" value="<?//=GetMessage("SEARCH_GO")?>" />
